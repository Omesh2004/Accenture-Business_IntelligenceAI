...
The non-negotiables: read data only through the metric layer, write findings to the Signal Store,
...
forecasters (which would break the zero-training-data property).
...
Contributions are welcome. Before opening a pull request, please read the working rules that keep this codebase honest, and
