...
FACT_TABLES = {
    ...
    "fact_loan_applications": {"time_col": "created_at", "grain": "application",
                               "source": "nexabank_core"},
    "fact_loans": {"time_col": "started_at", "grain": "loan", "source": "nexabank_core"},
    "fact_account_daily": {"time_col": "snapshot_date", "grain": "account_day",
                           "source": "nexabank_core", "snapshot": True},
