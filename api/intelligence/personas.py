...
REGISTRY: dict[str, Persona] = {
    "cfo": Persona(
        ...
        examples=("What drove the change?", "What is the outlook?",
                  "Which metric moved most?", "How reliable is this figure?",
                  "What did this analysis cost?"),
    ...
    "ops_manager": Persona(
        ...
        examples=("What drove the change?", "Where is it concentrated?",
                  "What action is recommended?", "Which metric moved most?",
    ...
    "analyst": Persona(
        ...
        kpi_preference=(),
        examples=("What drove the change?", "Where is it concentrated?",
                  "Was it price or volume?", "What is the outlook?",
                  "Which KPIs do you track?", "What did this analysis cost?"),
