...
REGISTRY: dict[str, Persona] = {
    "cfo": Persona(
        ...
        kpi_preference=("revenue", "pro_revenue", "loan_approval_volume"),
    ...
    "ops_manager": Persona(
        ...
        kpi_preference=("kyc_completion_rate", "new_account_signups",
    ...
    "marketing_lead": Persona(
        ...
        kpi_preference=("new_account_signups", "kyc_completion_rate", "revenue"),
